      ...
      <Suspense fallback={<LoadingSpinner />}>
        <Routes>
          ...
          >
            ...
            <Route
              path="designationMaster/employeeModuleAccess/:designationMasterId"
              element={<EmployeeModuleAccess />}
            />
            ...
            <Route
              path="branchAssociationsMaster"
              element={<BranchAssociationsMaster />}
            />
            ...
            <Route
              path="holidayMappingMaster"
              element={<HolidayMappingMaster />}
            />

            <Route
              path="leaveEncashmentMaster"
              element={<LeaveEncashmentMaster />}
            />
            ...
            />
            <Route
              path="weekOffMappingMaster"
              element={<WeekOffMappingMaster />}
            />
            ...
            />
            <Route
              path="inventory/inventorySpecification"
              element={<InventorySpecification></InventorySpecification>}
            ></Route>
            <Route
              path="parking"
              element={
            ...
            <Route
              path="category"
              element={<ProjectDocumentCategoryMaster />}
            />
            <Route path="document" element={<ProjectDocument />} />
            <Route
              path="approvalCategory"
              element={<ApprovalDocumentCategoryMaster />}
            />
            <Route path="approvalDocument" element={<ApprovalDocument />} />
            <Route
              path="reraCategory"
              element={<ProjectRERADocumentCategoryMaster />}
            />
            ...
            <Route
              path="channelPartner"
              element={
                <ChannelPartnerListStateProvider>
                  <ChannelPartner />
                </ChannelPartnerListStateProvider>
              }
            />
            <Route
              path="channelPartner/view"
              element={
                <ChannelPartnerListStateProvider>
                  <ViewChannelPartner />
                </ChannelPartnerListStateProvider>
            ...
            />
            <Route
              path="channelPartner/add/:ChannelPartnerId?"
              element={
                <ChannelPartnerListStateProvider>
                  <AddUpdateChannelPartner />
                </ChannelPartnerListStateProvider>
              }
            />
            ...
            <Route
              path="redevelopmentDashboard"
              element={<RedevelopmentDashboard />}
            />
            ...
            <Route
              ...
              element={<SiteProgressSubConstruction />}
            />
            <Route
              path="siteProgress/SiteProgressWingConstruction"
              element={<SiteProgressWingConstruction />}
            />
            <Route
              path="siteProgress/SiteProgressFloorConstruction"
              element={<SiteProgressFloorConstruction />}
            />
            <Route
              path="siteProgress/SiteProgressFlatConstruction"
              element={<SiteProgressFlatConstruction />}
            />
            <Route
              path="siteProgress/SiteProgressConstructionActivity"
              element={<SiteProgressConstructionActivity />}
            />
            <Route
              path="siteProgress/SiteProgressConstructionSubActivity"
              element={<SiteProgressConstructionSubActivity />}
            />
