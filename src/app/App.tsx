        ...
        <Routes>
          ...
          <Route path="/" element={<ProtectedRoute> <Layout /></ProtectedRoute>}>
            ...
            <Route
              path="jobRoleMaster"
              element={
                <JobRoleMasterListStateProvider>
                  <JobRoleMaster />
                </JobRoleMasterListStateProvider>
              }
            />
            <Route
              path="jobRoleMaster/add/:departmentId"
              element={
                <JobRoleMasterListStateProvider>
                  <AddUpdateJobRoleMaster />
                </JobRoleMasterListStateProvider>
              }
            />
            <Route
              path="jobRoleMaster/edit/:departmentId/:jobRoleId"
              element={
                <JobRoleMasterListStateProvider>
                  <AddUpdateJobRoleMaster />
                </JobRoleMasterListStateProvider>
            ...
            <Route
              path="jobOpenings"
              element={
                <JobOpeningListStateProvider>
                  <JobOpening />
                </JobOpeningListStateProvider>
              }
            />
            <Route
              path="jobOpenings/add/:jobOpeningId?"
              element={
                <JobOpeningListStateProvider>
                  <AddUpdateJobOpening />
                </JobOpeningListStateProvider>
