...
export default function NoticesTable({ }){
    ...
    return (
        <div className="space-y-3 pt-4 sm:pt-5">
            <div className="bg-white rounded-xl p-4 h-[300px] border border-gray-100 flex flex-col" style={{ boxShadow: "0px 1px 2px rgba(0,0,0,0.05)" }}>
                {/* Section Header */}
                <p className="text-[13px] font-semibold text-gray-500 tracking-wide pb-3 pl-1">
