...
export const AchievementBookingReport: React.FC<Props> = ({ filterType, fromDate, toDate, projectId, employeeId, tabName, columnKey }) => {
    ...
    const loadBookingData = useCallback(async (page: number = pagination.currentPage) => {
        ...
        await runApiWithLoader(
            ...
            async () => {
                ...
                const response = await achievementReportService.apiCallPullBookingReport(params);
    ...
    const [selectedBookingColumnKeys, setSelectedBookingColumnKeys] = useState<string[]>(() => {
        try {
            ...
            const saved = LocalStorageHelper.getAchievementByBookingTableColumns?.();
        ...
        <div>
            ...
            <CustomizeColumnsModal
                ...
                onApply={keys => {
                    ...
                    try {
                        LocalStorageHelper.storeAchievementByBookingTableColumns?.(
