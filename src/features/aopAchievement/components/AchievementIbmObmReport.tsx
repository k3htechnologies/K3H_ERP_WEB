...
import { aopAchievementReportService } from "@/features/aopAchievement/services/AopAchievementReportService";
...
export const AchievementIbmObmReport: React.FC<Props> = ({ filterType, fromDate, toDate, channelPartnerId, tabName, columnKey }) => {
    ...
    const loadIbmObmData = useCallback(async (page: number = pagination.currentPage) => {
        ...
        await runApiWithLoader(
            ...
            async () => {
                ...
                const response = await aopAchievementReportService.apiCallPullIBMOBMReport(params);
    ...
    const [selectedIbmObmColumnKeys, setSelectedIbmObmColumnKeys] = useState<string[]>(() => {
        try {
            ...
            const saved = LocalStorageHelper.getAchievementByChannelPartnerIbmObmTableColumns?.();
        ...
        <div>
            ...
            <CustomizeColumnsModal
                ...
                onApply={keys => {
                    ...
                    try {
                        LocalStorageHelper.storeAchievementByChannelPartnerIbmObmTableColumns?.(
