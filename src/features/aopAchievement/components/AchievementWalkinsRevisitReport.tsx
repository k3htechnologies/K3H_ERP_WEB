...
export const AchievementWalkinsRevisitReport: React.FC<Props> = ({ filterType, fromDate, toDate ,channelPartnerId, tabName, columnKey}) => {
    ...
    const loadWalkinsRevisitData = useCallback(async (page: number = pagination.currentPage) => {
        ...
        await runApiWithLoader(
            ...
            async () => {
                ...
                const response = await aopAchievementReportService.apiCallPullWalkinsRevisitReport(params);
    ...
    const [selectedWalkinsRevisitColumnKeys, setSelectedWalkinsRevisitColumnKeys] = useState<string[]>(() => {
        try {
            ...
            const saved = LocalStorageHelper.getAchievementByChannelPartnerWalkinsRevisitTableColumns?.();
        ...
        <div>
            ...
            <CustomizeColumnsModal
                ...
                onApply={keys => {
                    ...
                    try {
                        LocalStorageHelper.storeAchievementByChannelPartnerWalkinsRevisitTableColumns?.(
