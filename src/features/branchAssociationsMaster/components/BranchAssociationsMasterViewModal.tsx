...
interface BranchAssociationsMasterViewModalProps {
  isOpen: boolean;
  onClose: () => void;
  data: BranchAssociationsMasterData | null;
  canAction: boolean;
  onEdit: (data: BranchAssociationsMasterData) => void;
  onDelete: (data: BranchAssociationsMasterData) => void;
}

export const BranchAssociationsMasterViewModal: React.FC<BranchAssociationsMasterViewModalProps> = ({
  isOpen,
  onClose,
  data,
  canAction,
