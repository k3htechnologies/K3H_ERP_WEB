...
import { CompOffService } from '@/features/compOff/services/CompOffService'
import TooltipText from '@/ui/components/Tooltip/TooltipText';
import { handleExportFile } from '@/core/utils/exportFile';
import { Loader } from '@/core/utils/loader';
import { Modal } from '@/ui/components/Modal/Modal';
import { DateInput, DateRangePickerModal } from '@/ui/components/forms';
import { FieldItem } from '@/ui/components/forms/FieldItem';
import { DatePickerInput } from '@/ui/components/forms/Datepicker';
import { Edit, Trash2, Table, Plus, Download } from 'lucide-react';
import { 
  ...
  return (
    <>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        {/* Toolbar with inline filters on left and actions on right */}
        <div className="pb-4">
            ...
            <div className="flex items-center gap-4">
              <div className="w-[200px]">
                <DatePickerInput
                  ...
                  onChange={(value) => {
                    const updatedFilters = updateFilter(filters, 'StartDate', value || '');
                    setFilters(updatedFilters);
                    loadCompOff(1, updatedFilters);
                  }}
                />
              </div>
              <div className="w-[200px]">
                <DatePickerInput
                  ...
                  onChange={(value) => {
                    const updatedFilters = updateFilter(filters, 'EndDate', value || '');
                    setFilters(updatedFilters);
                    loadCompOff(1, updatedFilters);
                  }}
                />
            ...
            <div className="flex items-center space-x-1">
              ...
              <button
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  setIsShowCustomizeCompOffColumnsModal(true);
                }}
              ...
              {canExport && (
                <div className="relative">
                  ...
                  {exportDropdownOpen && (
                    <div className="absolute right-0 mt-2 min-w-[168px] bg-white rounded-md shadow-lg border border-gray-200 transition-all duration-150 z-50">
                      <div className="py-1">
        ...
        {isViewModalOpen && viewingCompOffData && (
    ...
    >
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          <FieldItem 
            label="Comp Off Date" 
            value={formatDateDisplay(data.CompOffDate)} 
            isRow 
            withBorder={true} 
          ...
          <FieldItem 
            label="Request Date" 
            value={formatDateDisplay(data.RequestDate)} 
            isRow 
            withBorder={true} 
          />
          <FieldItem 
            ...
            {onDelete && (
              <Button
                ...
                onClick={(e) => {
                  e.preventDefault()
                  e.stopPropagation()
                  if (window.confirm('Are you sure you want to delete this Comp Off?')) {
                    onDelete(data)
                    onClose()
                  }
                }}
