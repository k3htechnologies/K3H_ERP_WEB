    ...
    return (
        <div className="space-y-3 pt-5 px-2 lg:px-0">
            ...
            <div className="flex flex-col lg:flex-row gap-4 w-full items-stretch">
                ...
                <div className="bg-white rounded-xl p-5 flex flex-col flex-2 h-[220px]  border border-gray-100" style={{ boxShadow: "0px 1px 2px rgba(0,0,0,0.05)" }}>
                ...
                {hasValidManager && (
                    <div className="bg-white rounded-xl p-5 flex flex-col flex-1 h-[220px]  border border-gray-100" style={{ boxShadow: "0px 1px 2px rgba(0,0,0,0.05)" }}>
