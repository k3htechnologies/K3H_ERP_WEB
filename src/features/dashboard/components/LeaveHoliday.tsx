    ...
    return (
        <div className="space-y-3 pt-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 mt-4">
                ...
                {/* Leave Balance Card: */}
                <div className="col-span-1 lg:col-span-3 bg-white rounded-xl p-5 shadow-sm h-[340px] overflow-y-auto thin-scroll">
                ...
                {/* Holiday Card: */}
                <div className="col-span-1 lg:col-span-3 rounded-xl bg-white p-5 h-[340px] overflow-y-auto thin-scroll shadow-sm ">
