...
import {
  ...
  isToDateGreaterOrEqualFromDate,
} from "@/core/utils/comman";
import { FieldItem } from "@/ui/components/forms/FieldItem";
import {
  fetchChannelPartnerByMobileNumber,
  fetchChannelPartnerTeamMemberDropdown,
...
export const AddUpdateEnquiry: React.FC = () => {
  ...
  const [formData, setFormData] = useState<AddUpdateEnquiryRequest>(() =>
    initialFormState(),
  );
  ...
  const [selectedVillageValues, setSelectedVillageValues] = useState<
    string | number | null
  >(null);
  ...
  const handleFieldChange = (
    field: keyof AddUpdateEnquiryRequest,
    value: any,
  ) => {
  ...
  const fetchEmployeesByDept =
    (dept: string) => (page: number, params?: { value?: string }) =>
        ...
        if (E.isRight(response)) {
          ...
          if (e) {
            setFormData((prev) => ({
              ...
              ChannelPartnerTeamMemberMobileNumber:
                Number(e.ChannelPartnerTeamMemberId) > 0
                  ? ""
                  : (e.ChannelPartnerTeamMemberMobileNumber ??
                    prev.ChannelPartnerTeamMemberMobileNumber),
              ChannelPartnerTeamMemberName:
                Number(e.ChannelPartnerTeamMemberId) > 0
                  ? ""
                  : (e.ChannelPartnerTeamMemberName ??
                    prev.ChannelPartnerTeamMemberName),
              ...
              CustomerClassification:
                e.CustomerClassification ?? prev.CustomerClassification,
              CountryOfResidence:
                e.CountryOfResidence ?? prev.CountryOfResidence,
            ...
            setChannelPartnerSearchByMobileNumber(
              e.ChannelPartnerMobileNumber
                ? e.ChannelPartnerMobileNumber.toString()
                : "",
            );
          }
        } else {
  ...
  const validateAddEnquiryForm = (): {
    ...
    if (mobile && !name) {
      newErrors.ChannelPartnerTeamMemberName =
        "Channel Partner Team Member Name is required";
    }

    // 2️⃣ If name entered → mobile required
    if (name && !mobile) {
      newErrors.ChannelPartnerTeamMemberMobileNumber =
    ...
    if (Number(formData.EnquiryDate) === 0 && !formData.EnquiryDate) {
      ...
      Number(formData.EnquiryDate) === 0 &&
      !isDateWithinPastDays(formData.EnquiryDate, 2)
    ) {
      newErrors.EnquiryDate =
        "Enquiry date can only be today or within the previous 2 days";
    }
    ...
    if (
      Number(formData.EnquiryId) === 0 &&
      formData.NextFollowUpDate != null &&
      ...
      newErrors.NextFollowUpDate =
        "Next Follow Up Date must be greater than or equal to Enquiry Date";
    }
    return {
  ...
  const PushEnquiryFormData = (): AddUpdateEnquiryRequest => {
    const villageIdsString =
      villageDropdown.selectedValues.length > 0
    ...
    const isIndian =
      ...
      formData.Nationality?.toUpperCase() === "Indian";
    ...
    return {
      ...
      ChannelPartnerTeamMemberName:
        Number(formData.ChannelPartnerTeamMemberId) > 0
          ? ""
      ...
      NextFollowUpDate:
        formData.NextFollowUpDate === "" ? null : formData.NextFollowUpDate,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                <SinglePageSelection
                  ...
                  onChange={(value) =>
                    handleFieldChange("Accommodation", value)
                  }
              ...
              <div>
                <SinglePageSelection
                  ...
                  onChange={(value) =>
                    handleFieldChange("OccupationType", value)
                  }
                  ...
                  formData.SubSource === "Advertisement" && (
                    <div>
                      <SinglePageSelection
                        ...
                        onChange={(value) =>
                          handleFieldChange("SubSubSource", String(value))
                        }
                          ...
                          <>
                            ...
                            <div>
                              <Input
                                ...
                                error={
                                  errors.ChannelPartnerTeamMemberMobileNumber
                                }
                              />
                            </div>
                          </>
                      ...
                      <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                          ...
                          {channelPartnerDesignation && (
                            <FieldItem
                              label="Designation"
                              value={channelPartnerDesignation}
                            />
                          )}
                          ...
                          {channelPartnerAadhaarCardNumber && (
                            <FieldItem
                              ...
                              value={channelPartnerAadhaarCardNumber}
                            />
                          )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3  gap-6">
                    ...
                    <div>
                      <SinglePageSelection
                        ...
                        onChange={(value) =>
                          handleFieldChange("PossessionType", value)
                        }
                    ...
                    <div>
                      <SinglePageSelection
                        ...
                        onChange={(value) =>
                          handleFieldChange("Requirement", value)
                        }
                    ...
                    {formData.Requirement && (
                      <div>
                        <SinglePageSelection
                          ...
                          onChange={(value) =>
                            handleFieldChange("RequirementType", value)
                          }
                          options={
                            formData.Requirement === "Residential"
                              ...
                              : formData.Requirement === "Commercial" ||
                                  formData.Requirement === "Commercial Leasing"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3  gap-6">
                    <div style={{ display: "none" }}>
                      <SinglePageSelection
                        ...
                        onChange={(value) =>
                          handleFieldChange("CustomerClassification", value)
                        }
                    ...
                    <div>
                      <SinglePageSelection
                        ...
                        onChange={(value) =>
                          handleFieldChange("SourceOfFunding", value)
                        }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                      <SinglePageSelection
                        ...
                        onChange={(value) =>
                          handleFieldChange("FinalStage", value)
                        }
                    ...
                    {formData.FinalStage === "Lost" && (
                      <div>
                        <SinglePageSelection
                          ...
                          onChange={(value) =>
                            handleFieldChange("FinalStageDetail", value)
                          }
                          options={FINAL_STAGE_DETAILS_TYPE_OPTIONS.map(
                            (opt) => ({ label: opt.name, value: opt.id }),
                          )}
                          error={errors.FinalStageDetail}
                          disabled={
                            Number(formData.EnquiryId) > 0 ? true : false
                          }
                        />
                      </div>
                    )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3  gap-6">
                <div>
                  <SingleSelectDropdownWithPagination
                    ...
                    onSelected={(item) =>
                      handleFieldChange("SalesAdvisorId", Number(item.value))
                    }
                    initialValue={createDropdownInitialValue(
                      formData.SalesAdvisorId,
                      dropdownLabels.SalesAdvisor,
                    )}
                ...
                <div>
                  <SingleSelectDropdownWithPagination
                    ...
                    dataFetchCallBack={fetchEmployeesByDept("Sale")}
                    onSelected={(item) =>
                      handleFieldChange("SourcingManagerId", Number(item.value))
                    }
                    initialValue={createDropdownInitialValue(
                      formData.SourcingManagerId,
                      dropdownLabels.SourcingManager,
                    )}
