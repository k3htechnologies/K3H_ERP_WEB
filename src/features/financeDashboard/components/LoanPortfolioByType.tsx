...
export default function LoanPortfolioByType({ }) {

    const statusData = [
        { name: 'Construction Finance (CF)', value: 12, color: "#22c55e" },
        { name: 'Loan Against Property (LAP)', value: 8, color: "#f59e0b" },
        { name: 'Lease Rental Discounting', value: 6, color: "#3b82f6" },
        { name: 'Overdraft Facility (OD)', value: 5, color: "#ef4444" },
    ]

    const totalValue = statusData.reduce((acc, item) => item.value + acc, 0)
