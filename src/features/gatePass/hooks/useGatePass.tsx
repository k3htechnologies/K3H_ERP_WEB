...
export const useGatePass = () => {
    ...
    const validateAddGatePassForm = (): {
        ...
        if (
            formData.NoOfParticipants === null ||
            formData.NoOfParticipants === undefined ||
            formData.NoOfParticipants === 0
        ) {
    ...
    const PushGatePassFormData = (): AddUpdateGatePassRequest => {
        ...
        return {
            ...
            // Check with passDateTime format
