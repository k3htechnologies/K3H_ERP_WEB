...
import { JobRoleDetailView, JobRoleListView } from '@/features/hireSpace/JobRoleMaster/components';
...
export const JobRoleMaster: React.FC = () => {
  ...
  const handleAddJobRoleModal = () => {
     navigate(`/jobRoleMaster/add/${selectedDepartment!.DepartmentId}`)
  };
  ...
  return (
    <div className="bg-[#F9FAFB] rounded-lg shadow-sm border border-gray-200 p-5">
      ...
      <TableActionToolbar
        ...
        isShowAddButton={selectedJobRole ? false : canAction}
        addTitle="Add"
        onAdd={handleAddJobRoleModal}
        ...
        <div className="flex gap-5 items-start">
          ...
          <div className="w-100 shrink-0 flex flex-col gap-2 bg-white">
            ...
            <div className="pr-3 pl-3">
              ...
              <Tabs
                tabs={departmentTabs}
                defaultActive={selectedDepartment.DepartmentId != null ? String(selectedDepartment.DepartmentId) : undefined}
                isvertical
                onTabChange={(tab) => {
          ...
          <div className="flex-1 min-w-0 border border-gray-200 rounded-lg overflow-hidden p-5">
            {selectedJobRole ? (
              <JobRoleDetailView
