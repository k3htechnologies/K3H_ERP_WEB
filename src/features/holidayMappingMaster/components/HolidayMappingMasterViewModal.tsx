...
interface HolidayMappingMasterViewModalProps {
  isOpen: boolean;
  onClose: () => void;
  data: HolidayMappingMasterData | null;
  canAction: boolean;
  onEdit: (data: HolidayMappingMasterData) => void;
  onDelete: (data: HolidayMappingMasterData) => void;
}

export const HolidayMappingMasterViewModal: React.FC<HolidayMappingMasterViewModalProps> = ({
  isOpen,
  onClose,
  data,
  canAction,
