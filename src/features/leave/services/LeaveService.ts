...
export const LeaveService = {
  apiCallPullLeave: async (
    params: FilterWithPaginationLeaveRequest,
    options?: { signal?: AbortSignal },
  ): Promise<E.Either<Failure, LeaveListResponse>> => {
    try {
  ...
  apiCallAddUpdateLeave: async (
    params: AddUpdateLeaveRequest,
  ): Promise<E.Either<Failure, LeaveSaveResponse>> => {
    try {
  ...
  apiCallDeleteLeave: async (
    params: DeleteLeaveRequest,
  ): Promise<E.Either<Failure, LeaveDeleteResponse>> => {
    try {
