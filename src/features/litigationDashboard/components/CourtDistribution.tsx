        ...
        <div className="pt-5">
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-100">
                ...
                <div className="h-[280px]">
                    <ResponsiveContainer>
                        <BarChart
                            data={courtData} layout="vertical" barGap={12}
                        >
                            ...
                            >
                                <LabelList dataKey="TotalCase" position="right" fill="#6b7280" fontSize={12}
                                />
                            </Bar>
                            ...
                            <Bar
                                ...
                                radius={[6, 6, 6, 6]}
                            >
                                <LabelList dataKey="OpenCase" position="right" dy={14} fill="#6b7280" fontSize={12}
                                />
                            </Bar>
