...
import type { FilterWithPaginationVendorForEnquiryRequest, FilterWithPaginationVendorForSelectedEnquiryRequest } from "../models/VendorFinalizeModel"
        ...
        await runApiWithLoader(
            ...
            async () => {
                ...
                if (E.isRight(response)) {
                    ...
                    const selected =
                        materialRequisitionVendorFinalizedList.filter(v => selectedVendorIds.includes(v.VendorId))
