...
interface NoticeSectionMasterFilterModalProps {
    isOpen: boolean;
    onClose: () => void;
    onApply: () => void;
    onClear: () => void;
...
export const NoticeSectionMasterFilterModal: React.FC<NoticeSectionMasterFilterModalProps> = ({
    isOpen,
    onClose,
    onApply,
    onClear,
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            title="Filter - Notice Section Master"
            onSubmit={(e) => {
                e.preventDefault();
                onApply();
            }}
