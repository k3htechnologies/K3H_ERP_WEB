...
import {
  ...
  StatusBadge,
  MapLink,
} from "../components/columnComponents";
...
export function usePayrollColumns() {
  ...
  const sharedCols = useMemo(
    () => ({
      punchIn: (w: string) => ({
        ...
        sortable: false,
        align: "left" as const,
        render: (v: any) => (v ? formatTimeFromDateTime(v) : "-"),
      }),
      punchInAddr: (w: string) => ({
        key: "PunchInAddress",
        label: "Punch In Address",
        width: w,
        sortable: false,
        align: "left" as const,
        render: (v: any) => <AddressTooltip value={v} />,
      }),
      punchOut: (w: string) => ({
        key: "PunchOut",
      ...
      workingHours: (w: string) => ({
        key: "WorkingHours",
        label: "Working Hours",
        width: w,
        sortable: false,
        align: "left" as const,
        render: (v: any) => fmtHours(v),
      }),
      status: (w: string) => ({
    ...
    [formatTimeFromDateTime, fmtHours],
  );
    ...
    () => [
      {
        ...
        align: "left",
        fixed: "left",
        render: (v) => <EmployeeTooltip value={v} />,
      },
      {
        key: "AttendanceDate",
        ...
        sortable: true,
        align: "left",
        render: (v) => (v ? formatDate_dd_MonthName_yy(v) : "-"),
      },
      {
        key: "PunchIn",
        label: "Punch In",
    ...
    () => [
      {
        ...
        sortable: false,
        align: "left",
        render: (v: any) => (v ? formatDate_dd_MonthName_yy(v) : "-"),
      },
  ...
  const COLUMNS_MAP: Record<TabId, TableColumn[]> = useMemo(
    ...
    [
      attendanceColumns,
      attendanceRegularizationColumns,
      compOffColumns,
      leaveColumns,
      outdoorColumns,
      resignationColumns,
