...
export abstract class ProjectMasterDatasource {
    ...
    abstract pullPaginationProjectMasterWithEmployee(PageSize: number, PageNumber: number, ProjectId: number, FullName?: string): Promise<ProjectMasterWithEmployeeResponse>;
...
export class ProjectMasterDatasourceImpl implements ProjectMasterDatasource {
    ...
    async pullPaginationProjectMasterWithEmployee(PageSize: number, PageNumber: number, ProjectId: number, FullName?: string): Promise<ProjectMasterWithEmployeeResponse> {
        try {
            const queryParams = new URLSearchParams({
                ProjectId: (ProjectId ?? 0).toString(),
