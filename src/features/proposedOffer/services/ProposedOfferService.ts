...
export const proposedOfferService = {
  //==================== PDF ====================
  apiCallPullProposedOfferPDF: async (
    params: FilterWithPaginationProposedOfferPdfRequest,
    options?: { signal?: AbortSignal },
  ): Promise<E.Either<Failure, ProposedOfferPDFResponse>> => {
    try {
  ...
  //==================== CORPUS ====================
  apiCallPullHardshipDetails: async (
    params: FilterWithPaginationProposedOfferHardshipDetailsRequest,
    options?: { signal?: AbortSignal },
  ): Promise<E.Either<Failure, ProposedOfferHardshipDetailsListResponse>> => {
    try {
  ...
  apiCallAddUpdateHardshipDetails: async (
    params: AddUpdateProposedOfferHardshipDetailsRequest,
  ): Promise<E.Either<Failure, ProposedOfferHardshipDetailsSaveResponse>> => {
    try {
  ...
  apiCallDeleteHardshipDetails: async (
    params: DeleteProposedOfferHardshipDetailsRequest,
  ): Promise<E.Either<Failure, ProposedOfferHardshipDetailsDeleteResponse>> => {
    try {
  ...
  //==================== RENT ====================
  apiCallPullTemporaryAlternateAccommodation: async (
    params: FilterWithPaginationProposedOfferTemporaryAlternateAccommodationRequest,
    options?: { signal?: AbortSignal },
  ): Promise<E.Either<Failure, ProposedOfferTemporaryAlternateAccommodationListResponse>> => {
    try {
      return E.right(await proposedOfferDatasource.pullTemporaryAlternateAccommodation(params, options?.signal));
    } catch (error: any) {
      return E.left({ message: error.message, code: error.code });
    }
  },

  apiCallAddUpdateTemporaryAlternateAccommodation: async (
    params: AddUpdateProposedOfferTemporaryAlternateAccommodationRequest,
  ): Promise<E.Either<Failure, ProposedOfferTemporaryAlternateAccommodationSaveResponse>> => {
    try {
      return E.right(await proposedOfferDatasource.addUpdateTemporaryAlternateAccommodation(params));
    } catch (error: any) {
      return E.left({ message: error.message, code: error.code });
    }
  },

  apiCallDeleteTemporaryAlternateAccommodation: async (
    params: DeleteProposedOfferTemporaryAlternateAccommodationRequest,
  ): Promise<E.Either<Failure, ProposedOfferTemporaryAlternateAccommodationDeleteResponse>> => {
    try {
      return E.right(await proposedOfferDatasource.deleteTemporaryAlternateAccommodation(params));
    } catch (error: any) {
      return E.left({ message: error.message, code: error.code });
    }
  },
  ...
  apiCallDeleteShiftingDetails: async (
    params: DeleteProposedOfferShiftingDetailsRequest,
  ): Promise<E.Either<Failure, ProposedOfferShiftingDetailsDeleteResponse>> => {
    try {
  ...
  apiCallDeleteSecurityDepositDetails: async (
    params: DeleteProposedOfferSecurityDepositDetailsRequest,
  ): Promise<E.Either<Failure, ProposedOfferSecurityDepositDetailsDeleteResponse>> => {
    try {
  ...
  //==================== BANK GUARANTEE ====================
  apiCallPullBankGuaranteeDetails: async (
    params: FilterWithPaginationProposedOfferBankGuaranteeDetailsRequest,
    options?: { signal?: AbortSignal },
  ): Promise<E.Either<Failure, ProposedOfferBankGuaranteeDetailsListResponse>> => {
    try {
      return E.right(await proposedOfferDatasource.pullBankGuaranteeDetails(params, options?.signal));
    } catch (error: any) {
      return E.left({ message: error.message, code: error.code });
    }
  },

  apiCallAddUpdateBankGuaranteeDetails: async (
    params: AddUpdateProposedOfferBankGuaranteeDetailsRequest,
  ): Promise<E.Either<Failure, ProposedOfferBankGuaranteeDetailsSaveResponse>> => {
    try {
      return E.right(await proposedOfferDatasource.addUpdateBankGuaranteeDetails(params));
    } catch (error: any) {
      return E.left({ message: error.message, code: error.code });
    }
  },

  apiCallDeleteBankGuaranteeDetails: async (
    params: DeleteProposedOfferBankGuaranteeDetailsRequest,
  ): Promise<E.Either<Failure, ProposedOfferBankGuaranteeDetailsDeleteResponse>> => {
    try {
      return E.right(await proposedOfferDatasource.deleteBankGuaranteeDetails(params));
    } catch (error: any) {
      return E.left({ message: error.message, code: error.code });
    }
  },
  ...
  apiCallAddUpdateProposedPlan: async (
    params: AddUpdateProposedPlanRequest,
  ): Promise<E.Either<Failure, ProposedOfferProposedPlanSaveResponse>> => {
    try {
  ...
  apiCallAddUpdateBuildingProposedPlanRequest: async (
    formData: FormData,
  ): Promise<E.Either<Failure, ProposedOfferProposedPlanSaveResponse>> => {
    try {
  ...
  apiCallCopyProposedPlan: async (
    params: CopyProposedPlanRequest,
  ): Promise<E.Either<Failure, ProposedOfferCopyProposedPlanSaveResponse>> => {
    try {
      return E.right(await proposedOfferDatasource.copyProposedPlan(params));
    } catch (error: any) {
      return E.left({ message: error.message, code: error.code });
    }
  },
  ...
  apiCallAddUpdateGenerateProposedOffer: async (
    params: AddUpdateGenerateProposedOfferRequest,
  ): Promise<E.Either<Failure, GenerateProposedOfferResponse>> => {
    try {
  ...
  // ==================== READY RECKONER ====================
  apiCallPullReadyReckonerRate: async (
    params: FilterWithPaginationProposedOfferReadyReckonerRateRequest,
    options?: { signal?: AbortSignal },
  ): Promise<E.Either<Failure, ProposedOfferReadyReckonerRateListResponse>> => {
    try {
  ...
  apiCallAddUpdateReadyReckonerRate: async (
    params: AddUpdateProposedOfferReadyReckonerRateRequest,
  ): Promise<E.Either<Failure, ProposedOfferReadyReckonerRateSaveResponse>> => {
    try {
  ...
  apiCallDeleteReadyReckonerRate: async (
    params: DeleteProposedOfferReadyReckonerRateRequest,
  ): Promise<E.Either<Failure, ProposedOfferReadyReckonerRateDeleteResponse>> => {
    try {
  ...
  apiCallPullAdditionalInformation: async (
    params: FilterWithPaginationAdditionalInformationRequest,
    options?: { signal?: AbortSignal },
  ): Promise<E.Either<Failure, AdditionalInformationListResponse>> => {
    try {
  ...
  apiCallAddUpdateAdditionalInformation: async (
    params: AddUpdateAdditionalInformationRequest,
  ): Promise<E.Either<Failure, AdditionalInformationSaveResponse>> => {
    try {
