...
const reports = [
  ...
  { title: "CP Performance", desc: "Channel Partner metrics", icon: <User2 className="w-5 h-5" />, color: "bg-[#FFF3E0]", iconColor: "text-[#FF9800]" },
  ...
  { title: "Closing Ratio", desc: "Conversion rates", icon: <CircleX className="w-5 h-5" />, color: "bg-[#FCE4EC]", iconColor: "text-[#E91E63]" },
