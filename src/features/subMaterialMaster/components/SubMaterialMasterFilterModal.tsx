...
interface SubMaterialMasterFilterModalProps {
  isOpen: boolean;
  onClose: () => void;
  onApply: () => void;
  onClear: () => void;
...
export const SubMaterialMasterFilterModal: React.FC<SubMaterialMasterFilterModalProps> = ({
  isOpen,
  onClose,
  onApply,
  onClear,
  ...
  onFilterChange,
  filterFields = [
    { key: 'SubMaterialName', label: 'Sub Material Name', placeholder: 'Enter Sub Material Name' },
