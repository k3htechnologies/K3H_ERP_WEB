...
import type { AddUpdateTaxTrackerRequest, DeleteTaxTrackerRequest, FilterWithPaginationTaxTrackerRequest, TaxTrackerData, TaxTrackerDocumentDetailsData } from "../models/TaxTrackerModel";
...
export const TaxTracker: React.FC = () => {
    ...
    const validateAddUpdateTaxTrackerDocumentForm = () => {
    ...
    const handleRequestForm = async (e?: React.FormEvent) => {
        ...
        const validation = validateAddUpdateTaxTrackerDocumentForm();
    ...
    const handleDeleteTaxTracker = async () => {
        ...
        await runApiWithLoader(
            ...
            async () => {
                ...
                const response =
                    await taxTrackerService.apiCallDeleteTaxTracker(params);
                ...
                <div className="space-y-4 p-6 bg-blue-100">
                    ...
                    {requestFormData.RequestType === 'Notice' && (
                        <>
                            ...
                            <div>
                                <Input type="text" label="Officer Name" placeholder="Officer Name" required value={requestFormData.OfficerName ?? ""} onChange={(e) => handleRequestFieldChange("OfficerName", e.target.value)} error={errors.OfficerName} />
                            </div>
