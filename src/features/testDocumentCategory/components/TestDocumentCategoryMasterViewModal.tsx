...
interface TestDocumentCategoryMasterViewModalProps {
  isOpen: boolean;
  onClose: () => void;
  data: TestDocumentCategoryMasterData | null;
  canAction: boolean;
  onEdit: (data: TestDocumentCategoryMasterData) => void;
  onDelete: (data: TestDocumentCategoryMasterData) => void;
}

export const TestDocumentCategoryMasterViewModal: React.FC<TestDocumentCategoryMasterViewModalProps> = ({
  isOpen,
  onClose,
  data,
  canAction,
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Test Document Category Details"
      onSubmit={(e) => {
        e.preventDefault();
        onClose();
      }}
    ...
    >
      <div className="space-y-6">
        <FieldItem
          ...
          value={data.TestDocumentCategoryName}
          isRow
          withBorder
