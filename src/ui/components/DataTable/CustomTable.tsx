                      ...
                      <td
                        ...
                        ${col.align === 'center'
                            ...
                            : col.align === 'right'
                              ...
                              : 'text-left'}
                         ${col.fixed === 'left'
                            ? 'sticky left-0 z-20 shadow-[2px_0_4px_rgba(0,0,0,0.1)] border-r-2 border-r-gray-100'
                            : col.fixed === 'right'
                              ? 'sticky right-0 z-20 shadow-[-2px_0_4px_rgba(0,0,0,0.1)] border-l-2 border-l-gray-100'
                              : ''}
                               `}
                        style={{
                          ...(col.width ? { width: col.width } : {}),
